...
export default tseslint.config(
  ...
  },
  {
    rules: {
      ...
      '@typescript-eslint/no-unsafe-assignment': 'off', // changed: warn instead of fully off
      ...
      'prettier/prettier': ['error', { endOfLine: 'lf', singleQuote: true, printWidth: 100 }], // changed: was "auto", sync with prettier config
    },
  },
);
